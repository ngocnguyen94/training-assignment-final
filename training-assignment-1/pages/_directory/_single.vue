                        ...
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                ...
                                <div class="blog-meta big-meta">
                                    <small><a href="marketing-single.html" title="">{{ thisArticle.publish_date }}</a></small>
                                    <small><a href="blog-author.html" title="">{{ thisArticle.status }}</a></small>
                            ...
                            <div class="single-post-media">
                                <img :src="thisArticle.banner_image" alt="" class="img-fluid">
                            </div><!-- end media -->

                            <div class="blog-content">
                                <div class="pp" v-html="thisArticle.description"></div>
                                <!-- end pp -->
                            </div><!-- end content -->
